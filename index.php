...
<body> 
    ...
    <main class="home">
        <div class="home__gradient">
            <nav class="nav">
                <h2 class="nav__logo">Doctor<span>-Zaid</span>
                </h2>
                <ul class="nav__list">
                    <form method="POST">
                    <li class="nav__item"><a href="#" class="nav__link active">home</a></li>
                    <li class="nav__item"><a href="#" class="nav__link">contact</a></li>
                    <li class="nav__item"><a href="register.php" class="nav__link">sign-in</a></li>
                    <button class="--outline-blue"><a href="login.php">Log-in</a></button> 
                    </form>
                </ul>
            </nav>
